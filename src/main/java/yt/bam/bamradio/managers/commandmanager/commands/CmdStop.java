...
public class CmdStop implements ICommand{
	...
	public void execute(CommandSender sender, String commandLabel, String[] args) {
            if(BAMradio.Instance.getRadioManager().isNowPlaying()) {
                ...
                Helpers.sendMessage(sender,BAMradio.Instance.getTranslationManager().getTranslation("COMMAND_STOP_MESSAGE"));
            }
	...
	public String getHelp() {
		return BAMradio.Instance.getTranslationManager().getTranslation("COMMAND_STOP_HELP");
	}
